...
var creatorList = ['@zainnbotz','@alpha'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'Zainnbotz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'Zainnbotz') return res.json(loghandler.invalidKey)
